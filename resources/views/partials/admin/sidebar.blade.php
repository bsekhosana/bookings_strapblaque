    ...
    <nav class="sidenav shadow-right">
        <div class="sidenav-menu">
            <div class="nav accordion" id="accordionSidenav">
                ...
                <a class="nav-link {{ \Ekko::isActiveRoute('admin.contact_forms.*') }}"
                ...
                @if (auth('admin')->user()->isSuperAdmin())
                    ...
                    <a class="nav-link {{ \Ekko::isActiveRoute('admin.settings.*') }}"
                    ...
                    <a class="nav-link {{ \Ekko::isActiveRoute('admin.admins.*') }}"
                        href="{{ route('admin.admins.index') }}">
                        <div class="nav-link-icon"><i class="fas fa-fw fa-user-gear"></i></div>
                        Admins
                    </a>
                    <a class="nav-link {{ \Ekko::isActiveRoute('admin.users.*') }}"
                ...
                @endif
                <div class="sidenav-menu-heading">Options</div>
                <a class="nav-link {{ \Ekko::isActiveRoute('admin.organization_settings.*') }}"
                    href="{{ route('admin.organization_settings.index') }}">
                    <div class="nav-link-icon"><i class="fas fa-fw fa-gear"></i></div>
                    Settings
                </a>
