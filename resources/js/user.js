...
/// Vue Components
//import ExampleComponent from './user/components/ExampleComponent.vue';
import BootstrapTheme from './user/components/BootstrapTheme.vue';

const app = vueApp({});
//app.component('example-component', ExampleComponent);
app.component('bs-theme-user', BootstrapTheme);
app.mount('#app');